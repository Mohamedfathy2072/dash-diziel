...
const SecureRoute = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <Box component="main">
      ...
      />
      <Box className="grid justify-stretch items-center !h-full">
        <DashboardSidebar />
        <Box
          className={`grid min-h-screen justify-stretch items-stretch self-stretch !content-between ${
            lang === "ar" ? "pr-[60px] lg:!pr-[0px]" : "pl-[60px] lg:!pl-[0px]"
          }`}
        >
          <PrimaryBox>
